      ...
      <div className="flex-grow flex items-center justify-center overflow-hidden px-4 lg:px-6">
        <div className="flex flex-col lg:flex-row w-full max-w-7xl mx-auto gap-8">
          ...
          <div className="flex flex-col justify-center lg:w-1/2 mt-32">
            ...
            <h2 className="font-quicksand text-2xl lg:text-4xl text-black font-semibold">
          ...
          <div className="relative flex flex-col justify-center items-center lg:w-1/2">
            ...
            <p className="text-center text-black font-bold text-5xl z-10 relative font-quicksand mt-4">
              UX/UI Designer
            </p>
          </div>
        </div>
